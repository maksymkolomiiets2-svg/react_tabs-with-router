...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://maksymkolomiiets2-svg.github.io/react_tabs-with-router/) and add it to the PR description.
